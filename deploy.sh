...
# cd
# openssl req -new -newkey rsa:2048 -nodes -keyout rapid.key -out rapid.csr
# cat rapid.crt rapid_bundle.crt > rapid_chained.crt
scp /Users/ccravens/Business/ossys/Projects/Rapid/rapid.io/rapid.key /Users/ccravens/Business/ossys/Projects/Rapid/rapid.io/rapid_chained.crt /Users/ccravens/Business/ossys/Projects/Rapid/rapid.io/jre-8u91-linux-i586.rpm root@rapid.io:/root
*******
...
--------------
# mv /root/rapid.key /etc/pki/tls/private/
# mv /root/rapid_chained.crt /etc/pki/tls/
--------------
...
# yum install -y /root/jre-8u91-linux-i586.rpm
...
==== Github Lingust =======
# mkdir /usr/local/ruby && curl https://cache.ruby-lang.org/pub/ruby/2.2/ruby-2.2.3.tar.gz | tar -xvz -C /usr/local/ruby
# cd /usr/local/ruby/ruby-2.2.3 && ./configure && make && make install
# ln -s /usr/local/ruby/ruby-2.2.3 /opt/ruby
...
http {
    ...
    server {
        listen			80;
        server_name		rapid.io www.rapid.io;

        if ($host != 'rapid.io' ) {
                rewrite  ^/(.*)$  https://rapid.io/$1  permanent;
        }
    ...
    server {
        ...
        ssl_certificate /etc/pki/tls/rapid_chained.crt;
        ssl_certificate_key /etc/pki/tls/private/rapid.key;
        ...
        location ~ ^/(images/|img/|javascript/|js/|css/|stylesheets/|flash/|media/|static/|robots.txt|humans.txt|favicon.ico) {
          root /home/git/rapid-web/public;
          access_log off;
          expires max;
        }
...
$ git clone git@github.com:rapid-io/rapid-web.git
$ git clone git@github.com:rapid-io/rapid-core.git
$ git clone git@github.com:rapid-io/rapid-ssh.git
...
Start Web Service
---------------
$ cd /home/git/rapid-web
$ git fetch
$ git rebase
$ rm -rf bower_components && rm -rf node_modules && bower install && npm install && gulp clean && gulp build
$ chmod +x /home/git/rapid-core/env.sh && /home/git/rapid-core/env.sh
$ pm2 start app.js --name "rapid"
$ pm2 save
$ exit
...
Prepare Rapid Core
----------------
*** Start a build for rapid-cli on Jenkins to automatically push Rapid engine
$ cd /home/git/rapid-core
$ npm install
$ git config --global user.email "git@rapid.io"
$ git config --global user.name "Rapid.io"
$ ln -s Rapid-v0.0.1.jar Rapid.jar
